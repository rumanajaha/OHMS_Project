...
import type { EmployeeStatus } from '../context/EmployeeContext';
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="card" style={{ padding: 0 }}>
        {/* Toolbar */}
        <div style={{ padding: '1.5rem', display: 'flex', gap: '1rem', flexWrap: 'wrap', borderBottom: '1px solid var(--border-color)' }}>
          <div className="search-bar" style={{ display: 'flex', alignItems: 'center', background: 'var(--bg-main)', padding: '0.5rem 1rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-color)', flex: 1, minWidth: '200px' }}>
                  ...
                  <tr key={emp.id} className="animate-fade-in">
                    ...
                    <td style={{ textAlign: 'right' }}>
                      <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.5rem' }}>
                        <button className="btn btn-ghost tooltip-trigger" style={{ padding: '0.25rem' }} title="View" onClick={() => navigate(`/admin/employees/view/${emp.id}`)}>
                          <Eye size={18} />
                        </button>
                        <button className="btn btn-ghost tooltip-trigger" style={{ padding: '0.25rem' }} title="Edit" onClick={() => navigate(`/admin/employees/edit/${emp.id}`)}>
                          <Edit2 size={18} />
                        </button>
                        <button className="btn btn-ghost text-danger tooltip-trigger" style={{ padding: '0.25rem' }} title="Delete" onClick={() => handleDelete(emp.id)}>
                          <Trash2 size={18} />
                        </button>
                      </div>
                    </td>
