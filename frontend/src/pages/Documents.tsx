                ...
                <tr key={doc.id}>
                  ...
                  <td style={{ textAlign: 'right' }}>
                    <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.5rem' }}>
                      <button className="btn btn-ghost" style={{ padding: '0.375rem', color: 'var(--primary)' }} title="Download" onClick={() => alert('Download simulated')}>
                        <Download size={16} />
                      </button>
                      <button className="btn btn-ghost text-danger" style={{ padding: '0.375rem' }} title="Delete" onClick={() => handleDelete(doc.id, doc.name)}>
                        <Trash2 size={16} />
                      </button>
                    </div>
                  </td>
