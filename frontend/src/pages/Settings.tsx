  ...
  return (
    <div className="animate-fade-in" style={{ maxWidth: '800px', margin: '0 auto', width: '100%' }}>
      ...
      <div className="card" style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        <div>
           <h3 className="h3" style={{ marginBottom: '1rem', borderBottom: '1px solid var(--border-color)', paddingBottom: '0.5rem' }}>{dict.preferences}</h3>
           <div className="form-group">
             <label className="form-label">System Mode</label>
             <select className="form-input" style={{ maxWidth: '300px' }} value={theme} onChange={(e) => setTheme(e.target.value as any)}>
        ...
        <div>
           <h3 className="h3" style={{ marginBottom: '1rem', borderBottom: '1px solid var(--border-color)', paddingBottom: '0.5rem' }}>Notifications</h3>
