...
export const AdminDashboard: React.FC = () => {
  ...
  const managersCount = employees.filter(e => e.designation.toLowerCase().includes('manager')).length;
        ...
        <div className="card" style={{ display: 'flex', flexDirection: 'column', minHeight: '400px' }}>
          ...
          <div style={{ flex: 1, border: '2px dashed var(--border-color)', borderRadius: 'var(--radius-md)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-muted)' }}>
            <div style={{ textAlign: 'center' }}>
               ...
               <a href="/admin/hierarchy" style={{ fontSize: '0.875rem', marginTop: '0.5rem', display: 'inline-block' }}>Open Full Map &rarr;</a>
            </div>
          </div>
        </div>
          ...
          <div className="card" style={{ flex: 1 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div style={{ borderLeft: '2px solid var(--border-color)', paddingLeft: '1rem', marginLeft: '0.25rem' }}>
                <p className="text-sm" style={{ color: 'var(--text-main)' }}>New department <strong>Design</strong> created.</p>
                <p className="text-xs text-muted">Just now</p>
              </div>
              <div style={{ borderLeft: '2px solid var(--border-color)', paddingLeft: '1rem', marginLeft: '0.25rem' }}>
                <p className="text-sm" style={{ color: 'var(--text-main)' }}>Employee <strong>John Smith</strong> onboarded.</p>
