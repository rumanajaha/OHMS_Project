...
import { useTasks, type TaskStatus, type TaskPriority } from '../context/TaskContext';
          ...
          <div style={{ flex: 1, marginRight: '1rem' }}>
            {isEditing ? (
              <input 
                ...
                style={{ fontSize: '1.5rem', fontWeight: 600, padding: '0.5rem' }}
              />
            ) : (
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', marginBottom: '2rem', padding: '1.5rem', background: 'var(--bg-main)', borderRadius: 'var(--radius-md)' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div>
              ...
              {isEditing ? (
                <select className="form-input" value={editedTask.priority} onChange={e => setEditedTask({ ...editedTask, priority: e.target.value as TaskPriority })} style={{ padding: '0.25rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div>
              ...
              {isEditing ? (
                <select className="form-input" value={editedTask.status} onChange={e => setEditedTask({ ...editedTask, status: e.target.value as TaskStatus })} style={{ padding: '0.25rem' }}>
